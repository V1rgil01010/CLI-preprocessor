        ...
        while True:
            ...
            if choice.lower() == "y":
                try:
                    ...
                    imputed_data = imp.fit_transform(self.data[[column]])
                    self.data[column] = imputed_data
                    print("Done......\U0001F601")
                    break
                except KeyError:
                    print("Column is not present. Try again.....\U0001F974")

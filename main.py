...
class Preprocessor:
    ...
    tasks = [
        ...
        '3. Encoding Categorical Data,Text Preprocessing',
        '4. Feature Scaling of the Dataset,outlier removal,LDA,PCA,SVD,Smoothing By Bin means and median',
        '5. Download the modified dataset(Test Train Split)'
    ]
